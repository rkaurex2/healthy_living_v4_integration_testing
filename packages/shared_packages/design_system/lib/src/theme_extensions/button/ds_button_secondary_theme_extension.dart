...
@immutable
class DSButtonSecondaryThemeExtension
    extends ThemeExtension<DSButtonSecondaryThemeExtension> {
  ...
  const DSButtonSecondaryThemeExtension({
  ...
  factory DSButtonSecondaryThemeExtension.defaultTheme(
    DSColorThemeExtension dsColors,
  ) {
    return DSButtonSecondaryThemeExtension(
      // Fill button colors
      fillNormal: DSButtonColors(
        background: dsColors.surfaceBrandDefault,
        textColor: dsColors.textOnSurfaceDefault,
        iconColor: dsColors.iconOnSurfaceDefault,
      ),
      fillPressed: DSButtonColors(
        background: dsColors.surfaceBrandPress,
        textColor: dsColors.textOnSurfaceDefault,
        iconColor: dsColors.iconOnSurfaceDefault,
      ),
      ...
      outlinePressed: DSButtonColors(
        background: dsColors.surfaceBrandLightPress,
        textColor: dsColors.textNeutralOnWhite,
        iconColor: dsColors.iconNeutralDefault,
        border: dsColors.strokeBrandDefault,
      ),
      ...
      outlineLoading: DSButtonColors(
        ...
        iconColor: dsColors.iconNeutralDefault,
        border: dsColors.strokeBrandDefault,
        loadingIconColor: dsColors.strokeBrandDefault,
      ),
  ...
  @override
  DSButtonSecondaryThemeExtension copyWith({
  ...
  @override
  DSButtonSecondaryThemeExtension lerp(
    ThemeExtension<DSButtonSecondaryThemeExtension>? other,
    double t,
  ) {
    if (other is! DSButtonSecondaryThemeExtension) {
      return this;
    }
