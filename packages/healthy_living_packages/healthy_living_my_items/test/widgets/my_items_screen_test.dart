...
// Keys wired in MyItemsScreen and its children:
//   my_items_screen        → Scaffold key on MyItemsScreen         ✓ tested
//   my_items_filter_all    → GestureDetector in HistoryTabContent  (needs auth + HistoryListLoaded)
//   my_items_empty_state   → Column in NoMyListWidget              (needs auth + empty lists)
//   create_list_button     → DSButtonPrimary in MyItemsListsWidget (needs auth + MyListsLoaded)
//   lists_screen           → MyItemsListsWidget key                (needs auth)
//   history_${type}_filter → SortByBottomSheetOptionTile           (needs sort bottom sheet open)
//   list_item_card_$i      → ProductRowItem in MyListDetailContent (needs list detail loaded)
// ---------------------------------------------------------------------------
...
void main() {
  ...
  // -------------------------------------------------------------------------
  // [MyItemsScreen] renders
  // -------------------------------------------------------------------------
  group('[MyItemsScreen] renders', () {
  ...
  // -------------------------------------------------------------------------
  // [MyItemsScreen] dark mode
  // -------------------------------------------------------------------------
  group('[MyItemsScreen] dark mode', () {
  ...
  // -------------------------------------------------------------------------
  // [MyItemsScreen] accessibility
  // -------------------------------------------------------------------------
  group('[MyItemsScreen] accessibility', () {
