...
part of 'food_detail_scores_model.dart';
...
@override
String toString() {
  return 'FoodDetailScoresModel(overall: $overall, ingredientScore: $ingredientScore, processingScore: $processingScore, nutritionScore: $nutritionScore, nutritionHazard: $nutritionHazard, ingredientHazard: $ingredientHazard, processingHazard: $processingHazard)';
}
...
/// @nodoc
abstract mixin class $FoodDetailScoresModelCopyWith<$Res>  {
  factory $FoodDetailScoresModelCopyWith(FoodDetailScoresModel value, $Res Function(FoodDetailScoresModel) _then) = _$FoodDetailScoresModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$FoodDetailScoresModelCopyWithImpl<$Res>
    implements $FoodDetailScoresModelCopyWith<$Res> {
  _$FoodDetailScoresModelCopyWithImpl(this._self, this._then);

  final FoodDetailScoresModel _self;
  final $Res Function(FoodDetailScoresModel) _then;
...
/// Adds pattern-matching-related methods to [FoodDetailScoresModel].
extension FoodDetailScoresModelPatterns on FoodDetailScoresModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FoodDetailScoresModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FoodDetailScoresModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FoodDetailScoresModel value)  $default,){
final _that = this;
switch (_that) {
case _FoodDetailScoresModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FoodDetailScoresModel value)?  $default,){
final _that = this;
switch (_that) {
case _FoodDetailScoresModel() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$FoodDetailScoresModelCopyWith<_FoodDetailScoresModel> get copyWith => __$FoodDetailScoresModelCopyWithImpl<_FoodDetailScoresModel>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FoodDetailScoresModel&&(identical(other.overall, overall) || other.overall == overall)&&(identical(other.ingredientScore, ingredientScore) || other.ingredientScore == ingredientScore)&&(identical(other.processingScore, processingScore) || other.processingScore == processingScore)&&(identical(other.nutritionScore, nutritionScore) || other.nutritionScore == nutritionScore)&&(identical(other.nutritionHazard, nutritionHazard) || other.nutritionHazard == nutritionHazard)&&(identical(other.ingredientHazard, ingredientHazard) || other.ingredientHazard == ingredientHazard)&&(identical(other.processingHazard, processingHazard) || other.processingHazard == processingHazard));
}
...
/// @nodoc
abstract mixin class _$FoodDetailScoresModelCopyWith<$Res> implements $FoodDetailScoresModelCopyWith<$Res> {
  factory _$FoodDetailScoresModelCopyWith(_FoodDetailScoresModel value, $Res Function(_FoodDetailScoresModel) _then) = __$FoodDetailScoresModelCopyWithImpl;
@override @useResult
$Res call({
 double? overall,@JsonKey(name: 'ingredient') double? ingredientScore,@JsonKey(name: 'processing') double? processingScore,@JsonKey(name: 'nutrition') double? nutritionScore,@JsonKey(name: 'nutrition_hazard') String? nutritionHazard,@JsonKey(name: 'ingredient_hazard') String? ingredientHazard,@JsonKey(name: 'processing_hazard') String? processingHazard
});
...
/// @nodoc
class __$FoodDetailScoresModelCopyWithImpl<$Res>
    implements _$FoodDetailScoresModelCopyWith<$Res> {
  __$FoodDetailScoresModelCopyWithImpl(this._self, this._then);

  final _FoodDetailScoresModel _self;
  final $Res Function(_FoodDetailScoresModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? overall = freezed,Object? ingredientScore = freezed,Object? processingScore = freezed,Object? nutritionScore = freezed,Object? nutritionHazard = freezed,Object? ingredientHazard = freezed,Object? processingHazard = freezed,}) {
  return _then(_FoodDetailScoresModel(
overall: freezed == overall ? _self.overall : overall // ignore: cast_nullable_to_non_nullable
as double?,ingredientScore: freezed == ingredientScore ? _self.ingredientScore : ingredientScore // ignore: cast_nullable_to_non_nullable
as double?,processingScore: freezed == processingScore ? _self.processingScore : processingScore // ignore: cast_nullable_to_non_nullable
as double?,nutritionScore: freezed == nutritionScore ? _self.nutritionScore : nutritionScore // ignore: cast_nullable_to_non_nullable
