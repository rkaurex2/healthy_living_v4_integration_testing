...
import 'package:healthy_living_product_detail/src/ui/widget/ingredient_row_item.dart';
import 'package:healthy_living_shared/healthy_living_shared.dart'
    show IngredientItemUIModel, ProductCategory, StringConstants;
...
class _IngredientListWidgetState extends State<IngredientListWidget> {
  ...
  String _getHasOverFlowText(
    HealthyLivingProductDetailLocalizations localizations,
  ) {
