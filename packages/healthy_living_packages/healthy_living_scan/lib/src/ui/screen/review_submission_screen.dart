...
import 'package:healthy_living_scan/src/ui/widgets/review_submission_content_screen.dart';
...
class ReviewSubmissionScreen extends StatelessWidget {
  ...
  const ReviewSubmissionScreen({required this.infoUIModel, super.key});
              ...
              (_) =>
                  injector.get<SubmitProductBloc>()..add(
                    SubmitProductEvent.started(
                      productCategory: infoUIModel.productCategoryType,
                    ),
                  ),
          child: Column(
            ...
            children: [
              ...
              SubmitProductProgressWidget(
                currentStep: SubmitProgressSteps.reviewSubmission.progressFor(
              ...
              Expanded(
                child: ReviewSubmissionContentScreen(infoUIModel: infoUIModel),
              ),
            ],
          ),
        ),
