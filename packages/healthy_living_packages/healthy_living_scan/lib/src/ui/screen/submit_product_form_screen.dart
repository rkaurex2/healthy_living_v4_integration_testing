...
import 'package:healthy_living_scan/src/ui/widgets/submit_product_form_content_screen.dart';
import 'package:healthy_living_scan/src/ui/widgets/submit_product_progress_widget.dart';
import 'package:healthy_living_shared/healthy_living_shared.dart';

class SubmitProductFormScreen extends StatelessWidget {
  final SubmitProductInfoParams infoUIModel;

  const SubmitProductFormScreen({required this.infoUIModel, super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            SubmitProductProgressWidget(
              currentStep: SubmitProgressSteps.form.progressFor(
            ...
            Expanded(
              child: SubmitProductFormContentScreen(infoUIModel: infoUIModel),
            ),
          ],
        ),
      ),
