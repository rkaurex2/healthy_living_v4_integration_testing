...
class BarcodeErrorView extends StatelessWidget {
  final String upcCode;
  final VoidCallback onClose;
  final VoidCallback onRetry;

  const BarcodeErrorView({
      ...
      child: Center(
        child: Column(
          children: [
            ...
            DSImage.asset(ScannerIcons.icBarcodeSymbol, width: context.dsSizes.sz600, height: context.dsSizes.sz600),
            ...
            DSText(
              text: localization.barcodeScanner_errorTitle,
            ...
            DSText(
              text: localization.barcodeScanner_errorMessage,
            ...
            DSButtonPrimary(
              ...
              text: localization.barcodeScanner_errorButtonTitle,
              leadingIconPath: ScannerIcons.icScannerIcon,
              onPressed: onRetry,
