...
class BrowseProductByCategoryHeaderSearch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final searchType = SearchType.fromName(type.value);
    return Container(
            ...
            child: DSSearch(
              ...
              onTap: () async {
                ...
                await injector.get<SearchAnalytics>().logSearchStart(
                  source: AnalyticsEvents.browseProductByCategoryScreen,
                );
                ...
                await context.pushNamed(
                  ...
                  extra: SearchScreenParams(
                    ...
                    searchType:
                        searchType == SearchType.sunscreen
                            ? SearchType.personalCare
                            : searchType,
                    textInputHintText: _getHintText(
  ...
  String _getHintText(HealthyLivingSharedLocalizations localizations) {
    return switch (type) {
      ...
      BrowseProductByCategoryType.sunscreen =>
        localizations.healthyLivingShared_browseByProduct_searchSunscreen,
    };
  }
  ...
  String _getCategoryName({
    ...
    return switch (type) {
      ...
      BrowseProductByCategoryType.personalCare =>
        healthyLivingSharedLocalization.general_productCategory_personalCare,
      BrowseProductByCategoryType.cleaner =>
        healthyLivingSharedLocalization.general_productCategory_cleaners,
      BrowseProductByCategoryType.food =>
        healthyLivingSharedLocalization.general_productCategory_food,
      BrowseProductByCategoryType.sunscreen =>
