...
@UseCase(name: 'ds_button_primary_use_case', type: DSButtonPrimary)
Widget buildDSButtonPrimaryUseCase(BuildContext context) {
  final localizations = StyleguideLocalizations.of(context)!;

  return Center(
    child: DSButtonPrimary(
      type: context.knobs.list<DSButtonType>(
      ...
      leadingIconSize: context.knobs.listOrNull(
