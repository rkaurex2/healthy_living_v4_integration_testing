...
@UseCase(name: 'ds_button_icon_use_case', type: DSButtonIcon)
Widget buildDSButtonIconUseCase(BuildContext context) {
  final localizations = StyleguideLocalizations.of(context)!;

  return Center(
    child: DSButtonIcon(
      type: context.knobs.list<DSButtonIconType>(
        label: localizations.styleguide_type_label,
        options: DSButtonIconType.values,
